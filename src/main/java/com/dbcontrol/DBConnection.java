...
public interface DBConnection extends AutoCloseable {
     ...
     */
    int queryHandle(String sql, Object[] params, QueryHandler handler) throws SQLException;
     ...
     */
    int update(String tableName, DBRow row, Map<String, Object> fieldValues) throws SQLException;

    /**
     * Update a record in the named table using key-value pairs for the where statement.<br>
     * Fails if multiple records are updated or if no records are updated.
     */
    int update(String tableName, Map<String, Object> setValues, Map<String, Object> whereValues) throws SQLException;
     ...
     */
    Object insert(String tableName, String generatedKeyField, DBRow row, Map<String, Object> fieldValues) throws SQLException;

    /**
     * Insert a record into the named table with values from the provided fieldValues.
     */
    Object directInsert(String tableName, Map<String, Object> fieldValues) throws SQLException;
     ...
     */
    int delete(String tableName, DBRow row) throws SQLException;
