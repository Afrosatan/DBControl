...
public interface DBConnection extends AutoCloseable {
     ...
     */
    void queryHandle(String sql, Object[] params, QueryHandler handler) throws SQLException;
     ...
     */
    void update(String tableName, DBRow row, Map<String, Object> fieldValues) throws SQLException;
